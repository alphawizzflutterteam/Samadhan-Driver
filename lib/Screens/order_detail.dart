        ...
        child: Padding(
            ...
            child:
              ...
              Padding(
                  ...
                  child: widget.model!.address == null
                      ? Text("No address")
                      : Text(capitalize(widget.model!.address!),
                ...
                children: [
                  widget.model!.itemList![0].storeImage! == null
                      ...
                      : ClipRRect(
                          ...
                          child: widget.model!.itemList![0].storeImage! ==
                                      null ||
                              ...
                              : FadeInImage(
                                  ...
                                  width: 90.0,
                                  placeholder:
                                      AssetImage("assets/logo/login_logo.png"),
                                )),
                  Expanded(
                      child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
  ...
  Future<void> updateOrder(
    ...
    if (_isNetworkAvail) {
      try {
        ...
        print(" order update paramenter ${parameter.toString()}");
        Response response =
        ...
        if (!error) {
          if (item) {
            ...
            print("checking active status here ${widget.model!.activeStatus}");
            // widget.model!.itemList!.status = status;
          } else {
