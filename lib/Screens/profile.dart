...
class StateProfile extends State<Profile> with TickerProviderStateMixin {
  ...
  uploadProfileImg() async {
    var request = http.MultipartRequest('POST', updateImage);
    request.fields.addAll({'user_id': CUR_USERID!});
    request.files.add(await http.MultipartFile.fromPath('image', PROFILE_IMG!));
          ...
          child: CircleAvatar(
            ...
            child: Container(
              decoration: BoxDecoration(
                  ...
                  image: PROFILE_IMG == ''
                      ? null
                      : DecorationImage(image: NetworkImage(PROFILE_IMG!)),
