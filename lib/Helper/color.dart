...
const Color primary =Color(0xffA65125);
const Color secondary = Color(0xff4D4D4D);
const Color fontColor = Color(0xff000000);
const Color grad1Color = Color(0xffA65125);
const Color grad2Color = Color(0xffA65125);
...
const Color darkColor = Color(0xffA65125);
const Color darkColor2 = Color(0xffA65125);
